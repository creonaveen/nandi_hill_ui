...
const Footer = () => {
  return (
    <footer className="bg-seller-black text-white pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="font-bold text-xl text-white">SellHub</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              SellHub empowers entrepreneurs to create, manage, and grow their online businesses with our all-in-one ecommerce platform.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/" className="text-gray-400 hover:text-white transition-colors">Guides</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/" className="text-gray-400 hover:text-white transition-colors">Legal</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-gray-800 text-gray-400 text-sm">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} SellHub. All rights reserved.
            </div>
